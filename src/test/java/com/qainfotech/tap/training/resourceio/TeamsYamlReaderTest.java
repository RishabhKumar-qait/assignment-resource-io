...
public class TeamsYamlReaderTest {
    ...
    public void getListOfIndividuals_should_return_array_list_of_all_individual_objects()
        ...
        assertThat(teamReader.getListOfIndividual().size()).isEqualTo(5);
        assertThat(teamReader.getListOfIndividual().get(0).getName())
                .isEqualTo("John Doe");
        assertThat(teamReader.getListOfIndividual().get(4).getId())
                .isEqualTo(1205);
        assertThat(teamReader.getListOfIndividual().get(1).isActive())
                .isFalse();
        assertThat(teamReader.getListOfIndividual().get(3).isActive())
                .isTrue();
    }
